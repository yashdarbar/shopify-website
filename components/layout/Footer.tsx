      ...
      <div className="bg-primary-dark py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-2xl font-bold font-heading mb-2">Join the NutriBites Family</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="mt-2 text-sm text-cream/80 italic">Snack Smart, Live Better</p>
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm text-cream/70">
            ...
            {/* Payment Methods */}
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs text-cream/50">
              <span>We Accept:</span>
